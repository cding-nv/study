...
from bert.models import __multi_head_attention_grad
import time,timeit
import pdb
#import nvtx.plugins.tf as nvtx_tf

custom_module_lib_file = "/local/whale_workspace/whalemodelzoo/vanilla_mha_with_dropout_20210818/build/src/libcustomop.so"
...
def attention_layer(from_tensor,
  ...
  print('####Peak num_attention_heads * size_per_head =', num_attention_heads, size_per_head)
  ...
  #attention_scores, nvtx_context = nvtx_tf.ops.start(attention_scores, message='mha_custom_op')
  ...
  #attention_probs = nvtx_tf.ops.end(attention_probs, nvtx_context)
  ...
  for layer_idx in range(num_hidden_layers):
    with tf.variable_scope("layer_%d" % (layer_idx + start_layer_idx)):
      ...
      with tf.variable_scope("attention"):
        ...
        #print("### attention cost %.4f ms", (time_e - time_s)/1000)
