...
## Get model
```
$ huggingface-cli download abhinavkulkarni/meta-llama-Llama-2-7b-chat-hf-w4-g128-awq --cache-dir ./model_hf/
```
Refer to [README.md](../README.md) to use convert_awq_to_bin.py and weight_packer to get llama2-7b-awq-q4.bin
```
$ python ../convert_awq_to_bin.py models--abhinavkulkarni--meta-llama-Llama-2-7b-chat-hf-w4-g128-awq/.../pytorch_model.bin output
$ icpx -fsycl ./weight_packer.cpp -o weight_packer
$ ./weight_packer models--abhinavkulkarni--meta-llama-Llama-2-7b-chat-hf-w4-g128-awq/.../config.json output/ llama2-7b-awq-q4.bin 1
```
