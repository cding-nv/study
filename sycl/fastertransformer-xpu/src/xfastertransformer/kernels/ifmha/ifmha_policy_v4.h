...
struct ifmha_policy_base {
  static constexpr uint32_t accum_step_bmbc = 64;
  static constexpr uint32_t stages_bmbc = 3;
...
struct ifmha_policy_64x64 : ifmha_policy_base {
...
struct ifmha_policy_256x128 : ifmha_policy_base {
...
struct ifmha_policy_512x256 : ifmha_policy_base {
